...
const Tahfidz = (() => {
  ...
  function render() {
    Layout.setContent(window.TahfidzView.render());
  }
  ...
  async function loadSchedules() {
    const response = await TahfidzService.getScheduleToday();
  ...
  async function loadMaster() {
    try {
      const [rating, predikat, target] = await Promise.all([
        TahfidzService.getMasterRating(),
        TahfidzService.getMasterPredikat(),
        TahfidzService.getMasterTarget(),
      ]);
  ...
  function renderSchedules() {
    ...
    body.innerHTML = window.TahfidzView.renderScheduleList(state.scheduleList);
  }
  ...
  function updateAssessment(field, star) {
    ...
    TahfidzHelper.updateItem(state.assessment, field, star);
